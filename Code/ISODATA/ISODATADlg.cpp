...
#include <limits>
ISODATADlg::ISODATADlg(double SAMThreshold, int MaxIterations, int NumClus, double Lump, 
	double MaxSTDV, int SamPrm, QWidget* pParent) : QDialog(pParent)
{
   setModal(true);
   ...
   QLabel* pSamPrmLabel = new QLabel("Min Points in Cluster", this);
...
int ISODATADlg::getMaxIterations() const
{
   return mpMaxIterations->value();
}

int ISODATADlg::getNumClus() const
{
